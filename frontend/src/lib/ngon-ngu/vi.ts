/**
 * **Tiếng Việt — ngôn ngữ GỐC** của hệ thống (23/09/2026).
 *
 * Tệp này là **nguồn chân lý về cấu trúc khoá**: các ngôn ngữ khác dịch từ đây, và
 * `scripts/check-i18n-keys.py` so mọi tệp ngôn ngữ với tệp này để bắt khoá thiếu.
 *
 * Thêm khoá mới thì thêm vào ĐÂY trước, rồi mới dịch sang các tệp khác — ngược lại sẽ có khoá
 * chỉ tồn tại ở một ngôn ngữ và không ai phát hiện.
 */
const vi = {
  chung: {
    // Tiêu đề tab khi chưa biết trung tâm nào — xem `nhanDienTab.ts`.
    tieuDeTab: 'LangCenter — Quản lý trung tâm ngoại ngữ',
  ...
  */
  ...
  menu: {
    ...
    taiLieu: 'Tài liệu',
    khoaOnline: 'Khoá trực tuyến',
    thongKeCrm: 'Thống kê',
    hocPhi: 'Học phí',
    trangDich: 'Trang đích',
    noiDungTrangDich: 'Nội dung trang',
    lienHeTrangDich: 'Liên hệ',
  ...
  nguoiDung: {
    ...
    soTepDaDung: 'đã dùng {{so}}/{{toiDa}} tệp',
    datTenTep: 'Đặt tên tệp',
    doiTenTep: 'Đổi tên tệp',
    tenHienThi: 'Tên hiển thị',
    viDuTenTep: 'VD: Hợp đồng lao động 2026',
    giuDuoiTep: 'Không cần gõ đuôi tệp — hệ thống tự giữ (.pdf, .docx…)',
  ...
  thongKe: {
    ...
    thuDu: 'Đã thu đủ',
    soKyTruoc: 'so với kỳ trước',
    chuaCoKyTruoc: 'chưa có kỳ trước để so',
    soDonNgan: '{{so}} đơn',
    khongXacDinh: 'Không xác định',
    chuaCoDon: 'Chưa có đơn hàng nào trong kỳ này',
    chuaCoKhach: 'Chưa có khách hàng nào',
    doanhThuTheoThang: 'Doanh thu theo tháng',
    doanhThuTheoThangMoTa: 'Quy về VND bằng tỷ giá chụp lúc đăng ký — báo cáo cũ không đổi số.',
    theoCaNhan: 'Doanh thu theo cá nhân',
    theoCaNhanMoTa: 'Tính cho người tạo hồ sơ khách. Đơn cũ chưa có người tạo gom vào “Không xác định”.',
    theoDoiNhom: 'Doanh thu theo đội nhóm',
    theoDoiNhomMoTa: 'Theo phòng ban của người tạo hồ sơ khách.',
    theoSanPham: 'Doanh thu theo mặt hàng',
    theoSanPhamMoTa: 'Gồm cả khoá học và sản phẩm khác.',
  ...
  nguonKhachHang: {
    ...
    TuDangKy: 'Khách tự đăng ký',
  },
  khoaOnline: {
    ten: 'Tên khoá',
    trangThai: 'Trạng thái',
    moTa: 'Mô tả',
    chuaCo: 'Chưa có khoá trực tuyến nào',
    chuaCoBai: 'Khoá này chưa có bài học nào',
    chuaCoHocVien: 'Chưa cấp quyền học cho ai',
    themKhoa: 'Thêm khoá trực tuyến',
    suaKhoa: 'Sửa khoá',
    soBaiHoc: 'Số bài',
    soHocVien: 'Học viên',
    tienDo: 'Tiến độ',
    taoRaLaNhap: 'Khoá mới luôn ở trạng thái Nháp — soạn bài xong hãy chuyển sang Đang mở.',
    dangNhapGoiY:
      'Khoá đang ở trạng thái Nháp nên học viên chưa thấy, và chưa cấp quyền học được. '
      + 'Soạn xong bài thì sửa khoá và chuyển sang Đang mở.',
    tabBaiHoc: 'Bài học',
    tabHocVien: 'Học viên',
    themBai: 'Thêm bài',
    suaBai: 'Sửa bài',
    xoaBai: 'Xoá bài học',
    xoaBaiHoi: 'Xoá bài “{{ten}}”? Tiến độ học của học viên với bài này cũng mất theo.',
    tieuDeBai: 'Tiêu đề bài',
    thuTu: 'Thứ tự',
    noiDung: 'Nội dung',
    baiTrong: 'Bài này chưa có nội dung.',
    congKhai: 'Công khai',
    congKhaiGoiY:
      'Ai đăng nhập cũng đọc được, không cần ghi danh — kể cả khi đã hết hạn. Dùng cho bài '
      + 'giới thiệu, bài mẫu.',
    danhDauDaHoc: 'Đánh dấu đã học',
    capQuyen: 'Cấp quyền học',
    hoiTaoKhoa: 'Tạo khoá trực tuyến này? Khoá mới ở trạng thái Nháp, chưa ai thấy.',
    hoiLuuKhoa: 'Lưu thay đổi cho khoá này?',
    hoiLuuBai: 'Lưu bài học này?',
    hoiCapQuyen: 'Cấp quyền học khoá này cho học viên đã chọn?',
    thuQuyen: 'Thu quyền học',
    thuQuyenHoi: 'Thu quyền học của {{ten}}? Tiến độ đã học vẫn giữ, cấp lại thì học tiếp.',
    hocVien: 'Học viên',
    hetHan: 'Hết hạn',
    hetHanGoiY: 'Để trống = học vĩnh viễn.',
    ghiChuCap: 'Ghi chú',
    ghiChuVd: 'VD: mua đơn #123, học thử, tặng kèm lớp IELTS',
    nguoiCap: 'Người cấp',
    vinhVien: 'Vĩnh viễn',
  },
  trangThaiKhoaOnline: {
  ...
  lopHoc: {
    ...
    hocVienCuaLop: 'Học viên lớp {{lop}}',
    nhanVienKinhDoanh: 'Nhân viên kinh doanh',
    themTrucTiep: 'Hoặc thêm học viên có sẵn',
    themTrucTiepGiaLop: 'Học phí áp dụng lấy từ mức chuẩn của lớp',
  ...
  buoiHoc: {
    ...
    /*
      Khoá có BIẾN, không phải tiền tố rồi nối số (sửa 23/09/2026).

      Bản trước là `'Buổi '` rồi code tự ghép `{thuTu}`. Cách đó chỉ đúng với ngôn ngữ đặt số
      ở SAU. Tiếng Nhật và tiếng Hàn đếm kiểu **bao quanh** số (`第3回`, `3차시`) nên tiền tố
      thuần không diễn đạt được — ra `第3`, thiếu đuôi `回`.

      Để cả con số vào khoá thì mỗi ngôn ngữ tự đặt nó vào đúng chỗ của mình.
    */
    thuTuNgan: 'Buổi {{n}}',
  ...
  tieuChi: {
    ...
    sua: 'Sửa tiêu chí',
    ten: 'Tên tiêu chí',
    moTa: 'Gợi ý cho người chấm',
    nhomLabel: 'Nhóm',
    chuaCo: 'Chưa có tiêu chí nào',
    soLanDaCham: 'Đã chấm',
    hoiLuu: 'Lưu tiêu chí này?',
    giaiThich:
      'Tiêu chí dùng để chấm điểm thang 5. Nhóm Kinh doanh do quản lý chấm theo kỳ tháng; '
      + 'nhóm Giảng dạy do học viên chấm trong từng buổi học.',
    khongDoiNhom: 'Tiêu chí này đã có điểm nên không đổi nhóm được.',
    ngungDungGoiY:
      'Bỏ tích để ngừng dùng — phiếu mới không hiện nữa, phiếu cũ vẫn đọc được. Không xoá được '
      + 'tiêu chí đã chấm vì sẽ làm sai mọi kỳ đã đánh giá.',
    nhom: {
      KinhDoanh: 'Nhân viên kinh doanh',
      GiangDay: 'Giáo viên / trợ giảng',
    },
    nhomMoTa: {
      KinhDoanh: 'quản lý chấm theo kỳ tháng',
      GiangDay: 'học viên chấm trong từng buổi học',
    },
  },
  thongKeNs: {
    tabKinhDoanh: 'Kinh doanh',
    tabGiaoVien: 'Giáo viên',
    tabTroGiang: 'Trợ giảng',
    hoTen: 'Họ và tên',
    soHocVien: 'Số học viên',
    soLop: 'Số lớp',
    soBuoiDayDu: 'Buổi dạy đủ',
    soBuoiHuy: 'Buổi huỷ',
    chatLuongChamSoc: 'Chất lượng chăm sóc',
    chatLuongGiangDay: 'Chất lượng giảng dạy',
    soPhieu: '{{so}} phiếu',
    soLopNgan: '{{so}} lớp',
    cham: 'Chấm điểm',
    chamTieuDe: 'Chấm điểm nhân viên kinh doanh',
    ky: 'Kỳ đánh giá',
    kyGoiY: 'Mỗi nhân viên một phiếu cho mỗi kỳ — chấm lại là sửa phiếu cũ.',
    nhanXet: 'Nhận xét của quản lý',
    hoiLuuPhieu: 'Lưu phiếu đánh giá {{ten}} kỳ {{ky}}?',
    xepHangDoanhThu: 'Xếp hạng theo doanh thu',
    xepHangHocVien: 'Xếp hạng theo số học viên',
    xepHangHocVienMoTa: 'Khách do người này mang về và đã thật sự vào học.',
    xepHangBuoiDay: 'Xếp hạng theo số buổi dạy đủ',
    xepHangChatLuong: 'Xếp hạng theo chất lượng giảng dạy',
    xepHangChatLuongMoTa: 'Điểm trung bình do học viên chấm trên từng buổi học.',
    chuaCoNhanVienKd: 'Chưa có nhân viên kinh doanh nào.',
    chuaCoNguoi: 'Chưa có ai ở vai trò này.',
    chuaCoHocVien: 'Chưa có khách nào vào học trong kỳ.',
    chuaCoBuoi: 'Chưa có buổi dạy nào hoàn thành trong kỳ.',
    chuaCoDanhGia: 'Chưa có đánh giá nào trong kỳ.',
    chuaCoTieuChiKd:
      'Chưa có tiêu chí nhóm Kinh doanh — thêm ở tab Tiêu chí đánh giá rồi mới chấm được.',
    chuaCoTieuChiGd:
  ...
  chucNang: {
    ...
    ThongKeNhanSu: 'Thống kê nhân sự',
    DoanhThu: 'Doanh thu',
  ...
  ldp: {
    dangHienCongKhai: 'Đang hiển thị công khai',
    chuaXuatBan: 'Chưa xuất bản — khách chưa xem được',
    xuatBan: 'Xuất bản',
    goXuatBan: 'Gỡ xuất bản',
    seo: 'Tiêu đề & mô tả tìm kiếm',
    tieuDeSeo: 'Tiêu đề trang',
    tieuDeSeoGoiY: 'Bỏ trống thì dùng tên trung tâm',
    moTaSeo: 'Mô tả ngắn',
    dangTat: 'đang tắt',
    leenTren: 'Lên trên',
    xuongDuoi: 'Xuống dưới',
    tatKhoi: 'Tắt khối này',
    batKhoi: 'Bật khối này',
    tieuDeKhoi: 'Tiêu đề khối',
    moTaKhoi: 'Nội dung',
    nhanNut: 'Nhãn nút',
    nhanNutGoiY: 'Đăng ký học thử',
    duongDanNut: 'Nút dẫn tới',
    danhSachMuc: 'Danh sách mục',
    chuaCoMuc: 'Chưa có mục nào.',
    tenMucMoi: 'Tên mục mới',
    xacNhanXoaMuc: 'Xoá mục này?',
    xoaMucMatGi: 'Mục “{{ten}}” sẽ bị xoá khỏi trang đích. Không khôi phục được.',
    tieuDeMuc: 'Tiêu đề',
    phuDeMuc: 'Dòng phụ',
    moTaMuc: 'Mô tả',
    giaNiemYet: 'Giá niêm yết',
    danhSachLienHe: 'Liên hệ đã nhận',
    chuaCoLienHe: 'Chưa có liên hệ nào.',
    hoTen: 'Họ tên',
    soDienThoai: 'Điện thoại',
    quanTam: 'Quan tâm',
    loiNhan: 'Lời nhắn',
    ngayGui: 'Ngày gửi',
    daChuyenCrm: 'Đã chuyển CRM',
    ...
    khoi: {
      ...
      KhoaHoc: 'Chương trình học',
      GiaoVien: 'Đội ngũ giáo viên',
  ...
  heThong: {
    ...
    Lms: 'LMS — Đào tạo',
    Ldp: 'LDP — Trang đích',
    DungChung: 'Dùng chung mọi hệ thống',
    chuyenHeThong: 'Chuyển hệ thống',
    dungChungGoiY:
      'Các chức năng quản trị này dùng chung cho mọi hệ thống, nên hiện ở mọi tab.',
  },
  hrm: {
    moTaNvkd:
  ...
  loi: {
    ...
    KHOA_ONLINE_KHONG_HOP_LE: 'Khoá trực tuyến không hợp lệ',
    KHOA_ONLINE_DA_CO_NGUOI_HOC:
      'Khoá này đã có người học nên không xoá được. Chuyển sang “Ngừng cấp mới” để không cấp thêm.',
    KHOA_ONLINE_KHONG_NHAN_GHI_DANH:
      'Chỉ khoá đang mở mới cấp quyền học được. Khoá nháp chưa có nội dung; khoá ngừng cấp mới thì không nhận thêm người.',
    BAI_HOC_KHONG_DOI_DUOC_KHOA: 'Không chuyển được bài học sang khoá khác.',
    KHONG_XAC_DINH_DUOC_NGUOI_DUNG: 'Không xác định được người dùng hiện tại.',
    ...
    VUOT_SO_TEP_HO_SO: 'Mỗi hồ sơ chỉ lưu tối đa 10 tệp — xoá bớt tệp cũ rồi thử lại.',
    TIEU_CHI_THIEU_TEN: 'Tiêu chí phải có tên.',
    TIEU_CHI_TEN_QUA_DAI: 'Tên tiêu chí quá dài (tối đa 200 ký tự).',
    TIEU_CHI_TRUNG_TEN: 'Nhóm này đã có tiêu chí cùng tên.',
    TIEU_CHI_NHOM_KHONG_HOP_LE: 'Nhóm tiêu chí không hợp lệ.',
    TIEU_CHI_DA_CHAM_KHONG_DOI_NHOM:
      'Tiêu chí này đã được chấm điểm nên không đổi nhóm được — đổi nhóm sẽ làm sai mọi kỳ đã chấm. Hãy ngừng dùng nó và tạo tiêu chí mới ở nhóm kia.',
    TIEU_CHI_KHONG_THUOC_NHOM: 'Có tiêu chí không thuộc nhóm Kinh doanh.',
    DIEM_TIEU_CHI_KHONG_HOP_LE: 'Điểm phải từ 1 đến 5.',
    KY_DANH_GIA_KHONG_HOP_LE: 'Kỳ đánh giá phải có dạng yyyy-MM, ví dụ 2026-09.',
    KHONG_PHAI_NHAN_VIEN_KINH_DOANH: 'Chỉ chấm điểm được cho nhân viên kinh doanh.',
    TEN_TEP_KHONG_HOP_LE: 'Tên tệp không hợp lệ — hãy nhập ít nhất một ký tự.',
