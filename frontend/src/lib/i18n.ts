...
const vi = {
  ...
  dangNhap: {
    tieuDe: 'Đăng nhập',
    moTa: 'Nhập ID đội, tên đăng nhập và mật khẩu',
    maDoi: 'ID đội',
  ...
  thietLap: {
    ...
    moTa: 'Mô tả',
    maDoi: 'ID đội',
    maDoiKhongDoi: 'ID đội dùng để đăng nhập, không thể thay đổi',
  },
  // Bảng dịch MÃ LỖI từ backend — xem MaLoi.cs
  loi: {
    DANG_NHAP_THAT_BAI: 'ID đội, tên đăng nhập hoặc mật khẩu không đúng',
