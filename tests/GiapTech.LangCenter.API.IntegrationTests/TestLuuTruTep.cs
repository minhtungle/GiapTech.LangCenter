...
public class TestLuuTruTep(ICurrentTenant tenant) : ILuuTruTep
{
    ...
    /// <summary>
    /// Phải phủ được whitelist của `MinioLuuTruTep` ở những loại test dùng tới — thiếu Excel
    /// thì test "hồ sơ nhân sự nhận xlsx" đỏ vì BẢN GIẢ từ chối, không phải vì app sai.
    /// </summary>
