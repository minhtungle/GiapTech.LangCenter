...
80/443 — xem [ADR-0004](../02-kien-truc/adr/0004-ha-tang-tu-host-vps.md).
...
| [Checklist triển khai 23/09/2026](trien-khai-2026-09-23.md) | Đợt có **migration** và **đá mọi phiên đang mở** — đọc trước khi deploy |
