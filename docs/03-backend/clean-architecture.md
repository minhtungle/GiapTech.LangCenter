...
- Controller tổ chức theo version: `Controllers/V1/`, `Controllers/V2/` — xem
  [ADR-0003](../02-kien-truc/adr/0003-api-versioning.md).
...
1. Đọc mô tả FR-xx ở [docs/nghiep-vu/](../06-nghiep-vu/README.md).
2. Cập nhật [ERD](../05-database/erd.md) + migration nếu đổi dữ liệu.
