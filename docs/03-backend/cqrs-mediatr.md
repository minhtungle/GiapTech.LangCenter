...
[tài liệu nghiệp vụ](../06-nghiep-vu/README.md).
...
buộc tương ứng ở **tầng DB** — xem [ràng buộc ERD](../05-database/erd.md#ràng-buộc-nghiệp-vụ-quan-trọng).
...
Frontend dịch mã lỗi qua `react-i18next` — xem [ADR-0002](../02-kien-truc/adr/0002-frontend-shadcn-admin.md).
...
(xem hệ quả (−) ở [ADR-0003](../02-kien-truc/adr/0003-api-versioning.md)).
