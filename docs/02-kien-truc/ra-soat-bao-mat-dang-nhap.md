...
| 7. Token trong `localStorage` | ✅ **XONG** 22/09 — [ADR-0007](adr/0007-refresh-token-cookie-httponly.md) |
...
**Đã sửa 22/09/2026** theo [ADR-0007](adr/0007-refresh-token-cookie-httponly.md):
