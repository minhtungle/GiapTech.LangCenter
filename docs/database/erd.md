...
| `LOI_MOI_BAT_DOI` | Lời mời bắt đối giữa hai CLB (Sàn đối thủ) | id, **tenant_gui_id**, **tenant_nhan_id**, thoi_gian_de_xuat, dia_diem, loi_nhan, trang_thai, phan_hoi, tran_dau_nhan_id, tran_dau_gui_id | N—1 TENANT ×2 (**Restrict**) |
