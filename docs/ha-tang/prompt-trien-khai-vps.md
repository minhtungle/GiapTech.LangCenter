...
1. `docs/ha-tang/trien-khai-pull-code.md` — quy trình cho đúng luồng này (VPS pull code, build tại
   chỗ). Đây là tài liệu chính.
2. `docs/ha-tang/cai-dat-vps.md` — cài đặt VPS lần đầu, **mục 1 → 8**. **Bỏ qua mục 9** (secrets
