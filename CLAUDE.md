...
**28 mã FR chạy đầu-cuối** trên PostgreSQL + MinIO thật. 514 test backend · 28 frontend · 32 E2E xanh.
...
dotnet test           # 514 test: luật phụ thuộc, cách ly tenant, phân quyền, xác thực,
