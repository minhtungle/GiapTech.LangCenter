...
**18/20 mã FR chạy đầu-cuối** trên PostgreSQL + MinIO thật. 336 test backend xanh.
...
| **CRM** (FR-17 → FR-20): khách hàng + view 4 tab · doanh thu đa tiền tệ · **khoá học + sản phẩm** | |
...
| **20 mã FR** theo module | [`docs/nghiep-vu/`](./docs/nghiep-vu/README.md) |
| **ERD 32 bảng** + ràng buộc + hành vi xoá | [`docs/database/erd.md`](./docs/database/erd.md) |
...
dotnet test           # 336 test: luật phụ thuộc, cách ly tenant, phân quyền, xác thực,
...
# → 32 bảng (12 hệ thống + 20 nghiệp vụ) — xem docs/database/erd.md
