...
**28 mã FR chạy đầu-cuối** trên PostgreSQL + MinIO thật. 529 test backend · 28 frontend · 33 E2E xanh.
...
dotnet test           # 529 test: luật phụ thuộc, cách ly tenant, phân quyền, xác thực,
