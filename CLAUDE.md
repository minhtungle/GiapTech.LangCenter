...
**28 mã FR chạy đầu-cuối** trên PostgreSQL + MinIO thật. 504 test backend · 28 frontend · 28 E2E xanh.
...
dotnet test           # 504 test: luật phụ thuộc, cách ly tenant, phân quyền, xác thực,
