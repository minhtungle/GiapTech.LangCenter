...
**17/19 mã FR chạy đầu-cuối** trên PostgreSQL + MinIO thật. 330 test backend xanh.
...
| **CRM** (FR-17 → FR-19): khách hàng + **view 4 tab** · doanh thu đa tiền tệ · khoá học | |
...
| **ERD 31 bảng** + ràng buộc + hành vi xoá | [`docs/database/erd.md`](./docs/database/erd.md) |
...
dotnet test           # 330 test: luật phụ thuộc, cách ly tenant, phân quyền, xác thực,
...
# → 31 bảng (12 hệ thống + 19 nghiệp vụ) — xem docs/database/erd.md
