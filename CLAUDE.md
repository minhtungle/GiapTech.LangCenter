...
**Trạng thái:** ✅ **đủ 19 mã FR, chạy đầu-cuối trên PostgreSQL thật**. 370 test backend + 48 E2E xanh.
...
dotnet test                                         # 370 test: luật phụ thuộc, cách ly tenant, phân quyền, xác thực, 5 module nghiệp vụ
